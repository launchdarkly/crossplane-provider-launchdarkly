...
func (mg *Environment) GetTerraformResourceType() string {
	return "launchdarkly_environment"
}

// GetConnectionDetailsMapping for this Environment
func (tr *Environment) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"api_key": "status.atProvider.apiKey", "client_side_id": "status.atProvider.clientSideId", "mobile_key": "status.atProvider.mobileKey"}
}
