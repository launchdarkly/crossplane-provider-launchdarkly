...
func (in *ApprovalSettingsInitParameters) DeepCopyInto(out *ApprovalSettingsInitParameters) {
	*out = *in
	if in.AutoApplyApprovedChanges != nil {
		in, out := &in.AutoApplyApprovedChanges, &out.AutoApplyApprovedChanges
		*out = new(bool)
		**out = **in
	}
...
func (in *MetricInitParameters) DeepCopyInto(out *MetricInitParameters) {
	*out = *in
	...
	if in.EventKey != nil {
		in, out := &in.EventKey, &out.EventKey
		*out = new(string)
		**out = **in
	}
	if in.IncludeUnitsWithoutEvents != nil {
		in, out := &in.IncludeUnitsWithoutEvents, &out.IncludeUnitsWithoutEvents
		*out = new(bool)
		**out = **in
	}
	if in.IsActive != nil {
	...
	if in.IsNumeric != nil {
		in, out := &in.IsNumeric, &out.IsNumeric
		*out = new(bool)
		**out = **in
	}
	if in.Key != nil {
	...
	if in.MaintainerIDRef != nil {
		in, out := &in.MaintainerIDRef, &out.MaintainerIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.MaintainerIDSelector != nil {
		in, out := &in.MaintainerIDSelector, &out.MaintainerIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.Name != nil {
	...
	if in.RandomizationUnits != nil {
		in, out := &in.RandomizationUnits, &out.RandomizationUnits
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.UnitAggregationType != nil {
		in, out := &in.UnitAggregationType, &out.UnitAggregationType
		*out = new(string)
		**out = **in
	}
	if in.Urls != nil {
...
func (in *ProjectInitParameters) DeepCopyInto(out *ProjectInitParameters) {
	*out = *in
	...
	if in.RequireViewAssociationForNewFlags != nil {
		in, out := &in.RequireViewAssociationForNewFlags, &out.RequireViewAssociationForNewFlags
		*out = new(bool)
		**out = **in
	}
	if in.RequireViewAssociationForNewSegments != nil {
		in, out := &in.RequireViewAssociationForNewSegments, &out.RequireViewAssociationForNewSegments
		*out = new(bool)
		**out = **in
	}
	if in.Tags != nil {
